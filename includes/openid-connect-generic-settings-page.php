...
class OpenID_Connect_Generic_Settings_Page {
	...
	function __construct( OpenID_Connect_Generic_Option_Settings $settings, OpenID_Connect_Generic_Option_Logger $logger ) {
		...
		$fields = array(
			...
			'endpoint_login'    => array(
				...
				'example'     => 'https://rhb.clareityiam.net/idp/profile/oidc/authorization',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			...
			'endpoint_token'    => array(
				...
				'example'     => 'https://rhb.clareityiam.net/idp/profile/oidc/token',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'endpoint_end_session'    => array(
				...
				'example'     => 'https://rhb.clareityiam.net/idp/logout',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'identity_key'     => array(
	...
	public function admin_menu() {
		add_options_page(
			__( 'RAHB OIDC - Clareity RP Client' ),
			__( 'RAHB OIDC RP Client' ),
			'manage_options',
